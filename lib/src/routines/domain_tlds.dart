...
//
// Regenerate with tool/generate_tlds.dart.
//
...
/// The TLD tables backing `DomainValidator`.
///
...
///
/// 1 entries, sorted.
const List<String> infrastructureTlds = [
  'arpa',
];
...
///
/// 309 entries, sorted.
const List<String> countryCodeTlds = [
  'ac',
  'ad',
  'ae',
  'af',
